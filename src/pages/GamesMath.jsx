...
const MATH_GAMES = [
  { key: 'basic', name: 'games.math_basic', color: 'success', icon: 'bi-plus-slash-minus', to: '/games/math/basic-operations' },
  { key: 'fill', name: 'games.math_fill', color: 'info', icon: 'bi-123', to: '/games/math/fill-result' },
  { key: 'sequences', name: 'games.math_sequences', color: 'warning', icon: 'bi-list-ol', to: '/games/math/sequences' },
];
