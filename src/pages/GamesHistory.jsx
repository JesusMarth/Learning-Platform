...
const HISTORY_GAMES = [
  { key: 'truefalse', name: 'games.history_truefalse', color: 'success', icon: 'bi-check2-square', to: '/games/history/true-false' },
  { key: 'multiple', name: 'games.history_multiple', color: 'info', icon: 'bi-ui-radios', to: '/games/history/multiple-choice' },
  { key: 'order', name: 'games.history_order', color: 'warning', icon: 'bi-list-ol', to: '/games/history/order-events' },
];
  ...
  return (
    <div className="minigame-bg minigame-history">
      ...
      <div className="minigame-card mx-auto text-center animate__animated animate__fadeInDown" style={{ maxWidth: 520 }}>
        ...
        <h4 className="mb-4">{t('games.history_select')}</h4>
        {HISTORY_GAMES.map(game => (
